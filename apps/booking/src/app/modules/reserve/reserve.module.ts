...
@Module({
    imports: [ClientsModule.registerAsync([RabbitProvider(RABBIT_SERVICE.BOOKING_HOLD_DELAY), RabbitProvider(RABBIT_SERVICE.BOOKING_HOLD_DEMAND), RabbitProvider(RABBIT_SERVICE.BOOKING_HOLD_CANCEL)]), MongooseModule.forFeature([ReverseDestination])],
